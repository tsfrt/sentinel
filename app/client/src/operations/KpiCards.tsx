/**
 * Three KPI cards at the top of the Operations page: improper-payment exposure
 * / projected recovery / flagged count. When the agent's bulk write fires
...
export function KpiCards({ summary }: { summary: QueueSummary }) {
  return (
    <div className="grid grid-cols-3 gap-2 sm:gap-4">
      <Card
        label="Improper-payment exposure"
        value={summary.improperPaymentExposureUsd}
      ...
      <Card
        ...
        value={summary.projectedRecoveryUsd}
