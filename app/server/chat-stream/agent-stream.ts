...
export async function streamAgentTurn(args: {
   ...
   * space `genieSpaceId`. Set ONE — see caseops.ts AgentContext. */
  ...
  modelError: import('../agent/caseops.js').ModelErrorDetail | null;
}> {
  ...
  const modelError: { current: import('../agent/caseops.js').ModelErrorDetail | null } = {
    current: null,
  };
